...
const OrderFilter = ({ filters, onFilterChange }) => {
    ...
    const handleReturnStatusChange = (e) => {
        onFilterChange({ return_status: e.target.value });
    };
        ...
        <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div className="p-6 text-gray-900">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Trạng thái trả hàng</label>
                        <select
                            className="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                            value={filters.return_status || 'all'}
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Tìm kiếm (email)</label>
