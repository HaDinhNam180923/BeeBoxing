...
const EditCollection = ({ collectionId }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`/api/admin/collections/${collectionId}`, formPayload, {
        headers: {
      ...
      <AdminSidebar>
        <div className="container mx-auto py-6 px-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            {/* Thêm nút để chuyển sang trang quản lý sản phẩm */}
            <div className="mt-4">
              <button
                type="button"
                onClick={() => router.visit(`/admin/collections/${collectionId}/products/manage`)}
