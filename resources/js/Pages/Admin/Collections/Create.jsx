...
const CreateCollection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('/api/admin/collections', formPayload, {
        headers: {
  ...
  return (
    <AdminLayout title="Tạo bộ sưu tập mới">
      <AdminSidebar>
        <div className="container mx-auto py-6 px-4">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-bold">Tạo bộ sưu tập mới</h1>
