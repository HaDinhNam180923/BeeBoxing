...
export default function Welcome({ laravelVersion, phpVersion }) {
    ...
    return (
        <GuestLayout>
            <Head title="Chào mừng đến với BeeBoxing" />
                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg mb-8">
                        <div className="p-6 text-gray-900">
                            ...
                            <p>Khám phá các sản phẩm mới nhất và ưu đãi độc quyền. <Link href="/login" className="text-yellow-600 hover:underline">Đăng nhập</Link> hoặc <Link href="/register" className="text-yellow-600 hover:underline">đăng ký</Link> để bắt đầu mua sắm!</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-sm">
                            <h3 className="font-semibold text-lg mb-2">Tham gia BeeBoxing</h3>
                            <p className="text-gray-600">Tạo tài khoản để theo dõi đơn hàng và nhận đặc quyền độc quyền.</p>
                            <Link href="/register" className="text-yellow-600 font-medium mt-2 inline-block">Đăng ký ngay →</Link>
                        </div>
                    </div>
